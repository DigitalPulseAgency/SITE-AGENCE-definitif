      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-6">
          {services.map((s, i) => (
            ...
            >
              <TiltCard className={`h-full p-6 ${(s as any).highlight ? "border-2 border-[#6B3FE8]/60 shadow-[0_0_45px_rgba(107,63,232,0.35)]" : "border border-white/10"}`}>
                <Link to={s.href} className="flex h-full flex-col">
                  <div className="flex items-center justify-between">
                    <span className="grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br from-[var(--violet)] to-[var(--violet-glow)] shadow-lg shadow-[var(--violet)]/30">
